...
if (s.find('developer.oracle.com/codecard') != -1):
    ...
    command = (b"fingerprinta1=10740832e661e677dc5b342656c1e361bc82b97d\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprinta2=10740832e661e677dc5b342656c1e361bc82b97d\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprintb1=10740832e661e677dc5b342656c1e361bc82b97d\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprintb2=10740832e661e677dc5b342656c1e361bc82b97d\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
