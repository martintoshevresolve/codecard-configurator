...
print("PURPOSE:")
print ("  Code Card Configurator will update the Code Card fingerprint data and perform")
...
if (s.find('developer.oracle.com/codecard') != -1):
    ...
    command = (b"fingerprinta1=8b8ab033deb977a74dd17d48ebddff154d51e0a6\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprinta2=8b8ab033deb977a74dd17d48ebddff154d51e0a6\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprintb1=8b8ab033deb977a74dd17d48ebddff154d51e0a6\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
    command = (b"fingerprintb2=8b8ab033deb977a74dd17d48ebddff154d51e0a6\r\n")
    ser.write(command)
    time.sleep(.5)
    s = ser.read(85)
    print(s)
